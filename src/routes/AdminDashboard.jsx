      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          ...
          >
            ...
            <option value="virtual_dispatcher">Virtual Dispatcher</option>
            <option value="ala_carte">A La Carte</option>
            <option value="eld_monitoring_only">ELD Monitoring Only</option>
            <option value="back_office_command">Back Office Command</option>
            <option value="dot_readiness_audit">DOT Readiness Audit</option>
          </select>
        </div>
